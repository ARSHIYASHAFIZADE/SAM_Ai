...
function StackSection() {
  const stack = [
    { Icon: Code2Icon, name: 'Next.js 16', desc: 'App Router, React Server Components', color: '#f1f5f9' },
    ...
    { Icon: ServerIcon, name: 'Vercel', desc: 'Edge deployment with auto-scaling', color: '#94a3b8' },
  ]
  return (
    <section style={{ padding: '100px 24px', background: '#0a0f1e' }}>
      <div style={{ maxWidth: 1000, margin: '0 auto' }}>
